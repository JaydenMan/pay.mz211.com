...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a class="btn btn-primary radius" onclick="categoryAdd('增加分类','<?php echo url('admin/Goods/categoryAdd'); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 增加分类</a>
        </span>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-responsive">
            ...
            <tbody>
                ...
                <tr class="text-c">
                    ...
                    <!--<td style="text-align: left"><?php if($vo['level'] == '2'): ?><span>&nbsp;|_________  </span><?php endif; ?><?php echo $vo['name']; if($vo['level'] == '1'): ?>&emsp;<span class="badge badge-secondary radius">顶级</span><?php endif; ?></td>-->
                    <td style="text-align: left"><?php echo $vo['name']; ?></td>
                    <td><?php echo $vo['parent_id']; ?></td>
                    <td><a onClick="product_show('图片','product-show.html','10001')" href="javascript:;"><img width="60" class="product-thumb" src="https://img.alicdn.com/tfs/TB1qpwlQXXXXXcCXXXXXXXXXXXX-256-256.png_60x60.jpg_.webp?<?php echo $vo['image']; ?>"></a></td>
                    <td><?php echo $vo['sort_order']; ?></td>
                    <td><a class="badge <?php if($vo['is_show'] == '1'): ?>badge-success<?php else: ?>label-default<?php endif; ?> radius" href="javascript:;"><?php if($vo['is_show'] == '1'): ?>是<?php else: ?>否<?php endif; ?></a></td>
                    <td class="td-manage"><a style="text-decoration:none" onClick="product_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="categoryAdd('编辑分类','<?php echo url('admin/Goods/categoryAdd',['id'=>$vo['id']]); ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_del(this,'<?php echo $vo['id']; ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
    ...
    function product_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.ajax({
                type: 'POST',
                data: {id:id},
                url: "<?php echo url('admin/Goods/categoryDel','',''); ?>",
                dataType: 'json',
