...
<div class="page-container">
	<form action="<?php echo url('admin/Goods/goodsSave'); ?>" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
